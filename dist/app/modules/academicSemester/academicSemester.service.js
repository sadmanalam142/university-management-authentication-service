...
const acdemicSemester_model_1 = require("./acdemicSemester.model");
...
const createSemester = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield acdemicSemester_model_1.AcademicSemester.create(payload);
    return result;
});
const getSingleSemester = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield acdemicSemester_model_1.AcademicSemester.findById(id);
    return result;
});
const getAllSemesters = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield acdemicSemester_model_1.AcademicSemester.find(whereConditions)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit);
    const total = yield acdemicSemester_model_1.AcademicSemester.countDocuments(whereConditions);
    return {
        meta: {
            page,
            limit,
...
const updateSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield acdemicSemester_model_1.AcademicSemester.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteSemester = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield acdemicSemester_model_1.AcademicSemester.findByIdAndDelete(id);
    return result;
});
